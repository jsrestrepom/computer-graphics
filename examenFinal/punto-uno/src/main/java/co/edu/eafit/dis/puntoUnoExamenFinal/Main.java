package co.edu.eafit.dis.puntoUnoExamenFinal;
...
public class Main
{
    ...
    public static void main(String[] args) {
        ...
        projectionPlane.init(-25d, 25d, -25d, 25d, -50, Scene.WIDTH_IN_PIXELS, Scene.HEIGHT_IN_PIXELS);
        ...
        image.escribirImagen("1-RayTracing.ppm");
    }
